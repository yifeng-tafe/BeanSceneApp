...
class Order extends Component {
    ...
    searchByCategory=(text)=>{
        ...
        var url="http://localhost:5731/API/Food/Category/" + text;
        console.log(url)    
        var headers = new Headers({
            Authorization: 'Basic ' + btoa('test:test')
        }
    ...
    render() {
            ...
            return(
                <View style={{flexDirection:'row',justifyContent:'space-between', marginBottom:20}}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center'}}>
                        {/* <View>
                            <TouchableOpacity style={{alignItems:'center', justifyContent:'center', width:50, height:50, borderRadius:25,backgroundColor:'#1E90FF'}} onPress={()=> this.handleDecrement(item)}>
                                <Ionicons name="remove-outline" size={36} color={'white'}/>
                            </TouchableOpacity>
                        </View> */}
                        <View style={{marginHorizontal:20}}>
                            
                            <TextInput onChangeText={text=>this.setState({quantity:text})} style={{textAlign:'center',height:100,width:200, fontSize:80, borderColor:'grey', borderWidth:1}}>
        ...
        return (
            <View style={styles.container}>
                ...
                <Modal animationType="slide" transparent={true} visible={modalFoodOrderVisible} onRequestClose={() => { Alert.alert("Modal has been closed."); this.setModalFoodOrderVisible(!modalFoodOrderVisible)}} onShow={()=>this.searchonce(" ")}>
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <View style={[styles.overlayContainer,{width:wp('90%'), height:hp('100%'), alignItems:'center'}]}>
                            <View style={{width:'90%',flexDirection:'row', justifyContent:'space-between',alignItems:'flex-end'}}>
                                <View style={{flexDirection:'row', alignItems:'flex-end'}}>
                                    <Text style={{textAlign:'left',fontSize: 48,fontWeight: 'bold',marginBottom: 0,flexDirection: 'row',justifyContent: 'center'}}>
                                        Order Food
                                    </Text>
                                    <View style={{flexDirection:'row',paddingBottom:5, marginLeft:10}}>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#51DC8B', borderRadius:8, marginRight:10}} onPress={()=>this.searchByCategory("1")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Entrees
                                            </Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#FFA200', borderRadius:8, marginRight:10}} onPress={()=>this.searchByCategory("2")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Mains
                                            </Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#FF3E6C', borderRadius:8, marginRight:10}} onPress={()=>this.searchByCategory("3")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Desserts
                                            </Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#61BFC2', borderRadius:8, marginRight:10}} onPress={()=>this.searchByCategory("4")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Drinks
                                            </Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#F9CAA5', borderRadius:8, marginRight:10}} onPress={()=>this.searchByCategory("5")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Sides
                                            </Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity  style={{width:70, height:30,alignItems:'center',justifyContent:'center',backgroundColor:'#BC62FF', borderRadius:8}} onPress={()=>this.searchByCategory("6")}>
                                            <Text style={{fontSize:16, color:'white',alignContent:'center'}}>
                                                    Specials
                                            </Text>
                                        </TouchableOpacity>
